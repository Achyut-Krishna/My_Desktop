    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" alt="Achyut Krishna Sai Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Achyut Krishna Sai Adiraju</span> ,</div>
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                ...
                <li className="list-disc mt-5">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Class 12<sup>th</sup> (Essar International School Surat | CBSE)
                    </div>
                    <div className=" text-sm text-gray-400 mt-0.5">2019 - 2020</div>
                    <div className=" text-sm md:text-base">Maths, Physics, Chemistry</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">Percentile Rank &nbsp; 78.80%</div>
                </li>
            </ul>
        </>
    )
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/C%2B%2B-00599C?style=flat&logo=c%2B%2B&logoColor=white" alt="Krishna c++" />
                        <img className="m-1" src="http://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=ffffff" alt="Krishna python" />
                        <img className="m-1" src="https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white" alt="Krishna dart" />
                ...
                <div className="px-2 flex flex-wrap items-start w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white" alt="Krishna flutter" />
...
function Projects() {
    const project_list = [
        {
            name: "My Desktop",
            date: "Apr 2021",
            link: "https://github.com/Achyut-Krishna/My_Desktop.gitMy_Desktop.git",
            description: [
        ...
        },
        {
            ...
            date: "Dec 2021",
            link: "https://github.com/Achyut-Krishna/",
            description: [
    ...
    return (
        <>
            ...
            {/* <iframe src="https://github.com/sponsors/Krishna9patel/card" title="Sponsor Krishna9patel" className='my-4 w-5/6 md:w-3/4' ></iframe> */}
                            ...
                            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                                <div className="flex flex-wrap justify-between items-center">
                                    <div className='flex justify-center items-center'>
                                        ...
                                        {/* <iframe src={`https://ghbtns.com/github-btn.html?user=Krishna9patel&repo=${projectName}&type=star&count=true`} frameBorder="0" scrolling="0" width="150" height="20" title={project.name.toLowerCase()+"-star"}></iframe> */}
                                    </div>
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Achyut_Krishna Sai Adiraju_Resume.pdf" title="Achyut Krishna Sai Adiraju Resume" frameBorder="0"></iframe>
    )
}